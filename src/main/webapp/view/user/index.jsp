                    ...
                    <tbody>
                        <c:forEach var="usuario" items="${requestScope.userList}">
                            <tr>
                                ...
                                <td>
                                    <a class="link_visualizar_usuario" href="#" data-href="${pageContext.servletContext.contextPath}/user/read?id=${usuario.userId}">
                                        <span class="h4"><c:out value="${usuario.pNome}"/></span>
                                    </a>
                                </td>
